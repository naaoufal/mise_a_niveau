...
<body class="home">
	...
	<div class="container text-center">
		<br> <br>
		<h2 class="thin">Les Données De Résérvation</h2>
		<p class="text-muted">
		</p>
	</div>
<!-- /Intro-->
...
<div class="container">
	...
	<table class="table table-bordered">
		...
		<tr>
			<th>Chambre Sélecionner</th>
			<td><a class="btn btn-info" href="showroom.php?id=<?php echo $row->id_room?>">Infomration Sur Chambre</a></td>
		</tr>
	</table>
	<?php } ?>
</div>
...
<center>
	<a href="index.php" class="btn btn-primary">Retour Au Liste des Hotels</a>
</center>
